...
| 步骤 | 步骤名称 | 完成判定条件 | 续执起点 |
|---|---|---|---|
| 步骤 0 | P0 Gate（阻塞） | 所有基线文档校验通过，或已输出 `BLOCKED/FAIL` 结论 | 步骤 1 |
| 步骤 1 | 解析问题清单，建立整改映射 | `TEST_REVIEW_ISSUES.md` 所有问题已按优先级提取，整改映射已建立 | 步骤 2 |
| 步骤 2 | 逐条整改 | `docs/04-testing/TEST_CASES.md` 和 `docs/04-testing/TEST_PLAN.md` 已按问题清单完成定点修订 | 步骤 3 |
| 步骤 3 | 回写整改状态 | `docs/04-testing/TEST_REVIEW_ISSUES.md` 中所有问题整改状态已回写，文档状态更新为 `已整改` | 步骤 4 |
| 步骤 4 | 不得冻结的条件 | 已检查冻结条件，无阻塞则可更新 `TEST_CASES.md` 状态为 `已冻结` | 步骤 5 |
| 步骤 5 | 提示下一步 | 已向用户输出整改结果与下一步操作建议 | — |
